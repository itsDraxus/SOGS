...
public class FileController : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    private void Awake()
    {
        ...
        Vector2 originalPos = rectTransform.localPosition;
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {
            rectTransform.DOAnchorPos(originalPos, 0.1f);
        }
